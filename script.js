...
button.setAttribute('style','font-family: sans-serif; font-weight: 400; color: hsl(215, 96%, 36%); padding: 8px 16px; border-radius: 0px; border: 2px solid #0059d8; background: #fff; box-shadow: 4px 4px 0px 0px #0059d8; text-decoration: none; position: fixed; top: 24px; left: 24px; z-index: 9000;');
